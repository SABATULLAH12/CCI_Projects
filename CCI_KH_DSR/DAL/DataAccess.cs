...
namespace DAL
{
    public static class DataAccess
    {
        ...
        /// <returns></returns>
        public static DataTable GetQueryOutput(MdxConnection conn, string query)
        {
        ...
        /// <returns></returns>
        public static DataSet GetQueryOutput(MdxConnection conn, IList<string> queryList)
        {
